...
class State:
    ...
    class Teleport(Object):
        ...
        def draw(self):
            global Sys
            if Sys.score != Sys.clear:
                pygame.draw.rect(Root.win, (0,120,0), (self.x, self.y, self.wid, self.hei))
            else:
                pygame.draw.rect(Root.win, Root.teleport_color, (self.x, self.y, self.wid, self.hei))

        @staticmethod
        def event():
            if Sys.score != Sys.clear: pass
            else: Sys.teleport()
    ...
    class Coin(Object):
        ...
        def draw(self):
            if not self.collected:
                pygame.draw.rect(Root.win, Root.coin_color, (self.x, self.y, self.wid, self.hei))
            else: pass
    ...
    def tick(self):
        for i in self.objects:
            i.tick()
            i.collision()
        self.text = Root.font.render(f'스코어: {Root.score}', False, Root.wall_color)
        Root.win.blit(self.text, (20, 20))
...
class Room_1(State):
    ...
    Coin1 = State.Coin(250, 250, 10, 10)
    tele = State.Teleport(250, 290, 10, 10)

    def __init__(self):
        self.score = 0
        self.clear = 1
        self.objects = [Room_1.Wall1, Room_1.Wall2, Room_1.Wall3, Room_1.Wall4, Room_1.Wall5, Room_1.Enemy1, Room_1.Coin1, Room_1.tele]
    ...
    def init(self):
        self.objects[6].collected = False
...
class Room_2(State):
    ...
    Coin1 = State.Coin(240,60,10,10)
    Coin2 = State.Coin(240, 300, 10, 10)
    ...
    def __init__(self):
        self.score = 0
        self.clear = 2
        self.objects = [Room_2.Wall1, Room_2.Wall2, Room_2.Wall3, Room_2.Wall4, Room_2.Enemy1, Room_2.Enemy2,
                        Room_2.Enemy3, Room_2.Coin1, Room_2.Coin2, Room_2.tele]
    ...
    def teleport():
        ...
        Root.score += 1
        Sys = Room_3()
        DeathScreen.last_room = Room_3()
        Bob.go_start()

    def init(self):
        self.objects[7].collected = False
        self.objects[8].collected = False
...
class Room_3(State):
    ...
    Wall3 = State.Wall(50, 350, 310, 10)
    Wall4 = State.Wall(350, 50, 10, 310)
    Wall5 = State.Wall(50, 100, 270, 10)
    Wall6 = State.Wall(100, 200, 200, 10)
    Wall7 = State.Wall(50, 250, 270, 10)
    Enemy1 = State.Enemy(170, 55, 10, 10, 0, 340, 10)
    Enemy2 = State.Enemy(190, 55, 10, 10, 0, 340, 10)
    Enemy3 = State.Enemy(230, 55, 10, 10, 0, 340, 10)
    Coin1 = State.Coin(240,60,10,10)
    Coin2 = State.Coin(240, 300, 10, 10)
    ...
    def __init__(self):
        self.score = 0
        self.clear = 2
        self.objects = [Room_3.Wall1, Room_3.Wall2, Room_3.Wall3, Room_3.Wall4, Room_3.Wall5, Room_3.Wall6, Room_3.Wall7, Room_3.Enemy1, Room_3.Enemy2,
                        Room_3.Enemy3, Room_3.Coin1, Room_3.Coin2, Room_3.tele]
        self.player_startpoint = (100, 150, 10, 10)
    ...
    def init(self):
        self.objects[10].collected = False
        self.objects[11].collected = False




class DeathScreen(State):
    text = Root.font.render('사망하셨습니다', False, (Root.wall_color))
    last_room = Room_1()
